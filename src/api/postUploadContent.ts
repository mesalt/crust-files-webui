...
import type { PinRemoteInfo, UploadResponse } from "@/util/type";
...
async function postUploadContent(task: Task) {
    ...
    try {
        ...
        let res: UploadResponse | UploadResponse[] = await axiosAuth.post(`${userStore.upload_gateway}/api/v0/add?pin=true&cid-version=1&hash=sha2-256`, formData, {
            headers: {
        ...
        if (typeof res === 'string') {
            ...
            res = parsedObjects as UploadResponse[];
        }
